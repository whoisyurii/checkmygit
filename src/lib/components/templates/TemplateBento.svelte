	...
	<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
			...
			<div class="flex h-full flex-col">
				<div class="flex items-start gap-4">
					...
					<div class="flex-1">
						...
						<p class="text-text-secondary">@{profile.user.login}</p>
					</div>
				</div>
				...
				<div class="mt-4 flex items-center gap-4 text-sm text-text-tertiary">
					...
					<div class="flex items-center gap-1 text-text-secondary">
						...
						<span class="font-semibold text-text-primary">{views.toLocaleString()}</span>
					</div>
				</div>
			</div>
		</Card>
		...
		<Card variant="elevated" padding="lg">
			<div class="flex h-full flex-col items-center justify-center text-center">
				...
				<div class="mt-1 text-xs uppercase tracking-wider text-text-secondary">
					Repositories
				</div>
			</div>
		</Card>
		...
		<Card variant="elevated" padding="lg">
			<div class="flex h-full flex-col items-center justify-center text-center">
				<div class="text-4xl font-bold text-accent-yellow">
		...
		<Card variant="elevated" padding="lg">
			<div class="flex h-full flex-col items-center justify-center text-center">
				<div class="text-4xl font-bold text-accent-green">
		...
		<Card variant="elevated" padding="lg" class="md:col-span-2">
			<h3 class="mb-4 text-sm font-semibold text-text-secondary">Top Languages</h3>
		...
		<Card variant="elevated" padding="lg" class="md:col-span-2">
			<h3 class="mb-4 text-sm font-semibold text-text-secondary">Productivity Insights</h3>
			<div class="grid grid-cols-2 gap-4">
				<!-- Streak -->
				<div class="flex flex-col gap-1 rounded-xl bg-bg-primary p-4">
					...
					<div class="mt-2 text-2xl font-bold text-text-primary">
						{streak} <span class="text-sm font-normal text-text-secondary">days</span>
					</div>
				</div>
				...
				<div class="flex flex-col gap-1 rounded-xl bg-bg-primary p-4">
					...
					{:else}
						<div class="mt-2 text-sm text-text-secondary">No data</div>
					{/if}
				</div>
			</div>
		</Card>
