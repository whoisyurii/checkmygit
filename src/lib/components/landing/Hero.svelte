...
>
	<div class="animate-fade-in relative z-10 max-w-4xl">
		...
		<!-- Input Container -->
		<div
			class="glass-panel mx-auto flex w-full max-w-130 items-center gap-2 rounded-2xl p-2 transition-all focus-within:ring-2 focus-within:ring-accent-deep"
		>
			...
			<Button
				...
				loading={isLoading}
				class="h-10 rounded-xl px-6 font-semibold shadow-lg shadow-accent/20"
			>
				Generate
			</Button>
		</div>
