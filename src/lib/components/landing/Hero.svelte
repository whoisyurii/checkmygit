...
>
	<div class="animate-fade-in relative z-10 max-w-4xl">
		...
		<!-- Input Container -->
		<div
			class="glass-panel mx-auto flex w-full max-w-130 items-center gap-1.5 rounded-2xl p-2 transition-all focus-within:ring-2 focus-within:ring-accent-deep sm:gap-2"
		>
