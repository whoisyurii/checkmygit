...
<svelte:head>
	<title>{profile?.user.name || data.username} - GitHub Portfolio | CheckMyGit</title>
	<meta name="description" content="Explore {profile?.user.name || data.username}'s GitHub portfolio — projects, contributions, tech stack, and stats. {profile?.user.bio || 'View their open-source work and coding activity.'}" />
	<meta property="og:title" content="{profile?.user.name || data.username} - GitHub Portfolio | CheckMyGit" />
	<meta property="og:description" content="Explore {profile?.user.name || data.username}'s projects, contributions, and tech stack on CheckMyGit. {profile?.user.bio || 'View their open-source work and coding activity.'}" />
